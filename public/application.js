...
module.exports = {
  ...
  host: 'http://floating-anchorage-61832.herokuapp.com'
};
...
var onGetExpense = function onGetExpense(event) {
  // event.preventDefault()
  var data = getFormFields(this);
  console.log(data);
  console.log('made it to events page');
  // $('.new-post input').not('.submit-button').val('')
  api.getExpenses(data).then(ui.onGetExpenseSuccess).catch(ui.onError);
};
var onCreateExpense = function onCreateExpense(event) {
  ...
  api.createExpense(data).then(ui.onCreateExpenseSucess).catch(ui.onError);
};
// editing expense
var onEditExpense = function onEditExpense(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  console.log(data);
  api.editExpense(data).then(ui.editExpenseSuccess).catch(ui.onError);
};
var onDeleteExpense = function onDeleteExpense(event) {
  event.preventDefault();
  console.log(this.dataset.id);
  api.deleteExpense(this.dataset.id).then(ui.deleteExpenseSuccess).catch(ui.onError);
};

module.exports = {
  onGetExpense: onGetExpense,
...
var onCreateAccount = function onCreateAccount(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  console.log(data);
  if (data.credentials.password === data.credentials.password_confirmation) {
    // console.log('hit')
    api.createAccount(data).then(ui.createAccountSuccess) // if works
...
var signIn = function signIn(event) {
  ...
  event.preventDefault();
  console.log('hi');
  api.logInUser(data).then(ui.onSigninSuccess).catch(ui.onSigninFailure);
};
...
var resetPassword = function resetPassword(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.passwordReset(data).then(ui.onResetSuccess).catch(ui.onResetFailure);
};
...
var expenseEvents = __webpack_require__(5);
var getFormFields = __webpack_require__(6);
...
$(document).on('click', '.deleteExpense', expenseEvents.onDeleteExpense);
...
var passwordReset = function passwordReset(data) {
  // console.log(data)
  return $.ajax({
    method: 'PATCH',
...
var onLogoutSuccess = function onLogoutSuccess(data) {
  // console.log(data)
...
var onResetSuccess = function onResetSuccess() {
  $('#reset-success').empty();
...
var onResetFailure = function onResetFailure() {
...
var editExpense = function editExpense(data) {
...
var deleteExpense = function deleteExpense(data) {
  return $.ajax({
...
var loopExpenses = function loopExpenses(data) {
  // debugger
  $('#expenses').empty();
  for (var i = 0; i < data.expenses.length; i++) {
    var expenses = data.expenses.length;
    var kind = data.expenses[i].kind;
    var dueDate = data.expenses[i].dueDate;
    var amount = data.expenses[i].amount;
    var dataId = data.expenses[i].id;
...
var onCreateExpenseSucess = function onCreateExpenseSucess(data) {
  app.data = data.post;
  console.log(data);
  console.log('successfully posted');
  // $('#new-expense input').not('.submit-button').val('')
};
var onGetExpenseSuccess = function onGetExpenseSuccess(data) {
  app.data = data.user;
...
var editExpenseSuccess = function editExpenseSuccess(data) {
  console.log('expenses has been edited');
  console.log('you have reached ui.js update-posts');
};
var deleteExpenseSuccess = function deleteExpenseSuccess(data) {
  console.log('Post deleted');
};
module.exports = {
  onGetExpenseSuccess: onGetExpenseSuccess,
  onCreateExpenseSucess: onCreateExpenseSucess,
  onError: onError,
  editExpenseSuccess: editExpenseSuccess,
  deleteExpenseSuccess: deleteExpenseSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var tableHandlebars = function tableHandlebars(expense, kind, dueDate, amount, dataId) {
  var expensesTable = __webpack_require__(21);
  var context = {
    'expense': expense,
    'kind': kind,
    'dueDate': dueDate,
  ...
  var tableTemplate = expensesTable(context);
  $('#expenses').append(tableTemplate);
};

module.exports = {
  tableHandlebars: tableHandlebars
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"table-to-append\">\n  <table class=\"expensesTable\">\n    <tr>\n      <th>Kind</th>\n      <th>Date Due</th>\n      <th>Amount</th>\n      <th>Delete</th>\n    </tr>\n\n    <tr>\n\n      <td>"
    ...
    + "</td>\n      <td><button class=\"deleteExpense\" type=\"button\" data-id=\""
    ...
    + "\" name=\"deleteBtn\">Delete</button></td>\n\n    </tr>\n\n  </table>\n</div>\n";
},"useData":true});
